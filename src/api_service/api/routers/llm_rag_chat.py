...
import uuid
import time
from api.utils.llm_rag_utils import (chat_sessions,
                                     create_chat_session,
...
@router.get("/chats")
async def get_chats(x_session_id: str = Header(None, alias="X-Session-ID"),
...
async def continue_chat_with_llm(chat_id: str,
                                 message: Dict,
                                 x_session_id: str = Header(None,
                                                            alias="X-Session-ID")
                                 ):
